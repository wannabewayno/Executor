...
engine.update  = item => {
    ...
    //create and push prompt that asks for update values, so... we know the type (Employee, Department, Role);
    //Each of these have their own columns
    //tackle employee first.
    console.log(item);
    engine.queue('updateField');
