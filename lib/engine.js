...
//this is a reflexive function.
engine.create  = dataPacket => {
    console.log(dataPacket);
    creationTemplate = template[dataPacket.body]

    structure = creationTemplate.structure[creationTemplate.index];
    console.log(structure);

    engine.switch(structure)
    creationTemplate.next();
