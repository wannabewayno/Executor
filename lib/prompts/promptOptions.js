...
options.propertiesView = [
    new inquirer.Separator(),
    { name:'View employees by Id',           value:{ function:'viewBy',variable:{ head: null, body:['id'] }           }   },
    { name:'View employees by First name',   value:{ function:'viewBy',variable:{ head: null, body:['first_name','last_name'] }   }   },
    { name:'View employees by Last name',    value:{ function:'viewBy',variable:{ head: null, body:['last_name','first_name'] }    }   },
    { name:'View employees by Job title',    value:{ function:'viewBy',variable:{ head: null, body:['title','department_name'] }         }   },
    { name:'View employees by Salary',       value:{ function:'viewBy',variable:{ head: null, body:['salary','department_name'] }       }   }
];
